...
tags:
  - study
  - js
summary: 긴 작업을 효율적으로 처리하기 위해 yield와 setTimeout을 활용하여 사용자 경험을 최적화하는 방법을 설명합니다.
---
...
<p align="center">
  <img
    src="/content/2025-07-27-assets/0727-jglee96-1.png"
    alt="scheduler.yield와 requestAnimationFrame의 frame rate 비교"
    width={"50%"}
  />
</p>

- scheduler.yield는 우선 처리되므로 batch를 적용하지 않더라도 frame rate가 낮게 측정됨
- 변경 방안 - 원하는 프레임 속도에 맞춰 batch duration 조절 - scheduler.yield를 호출하기전
  requestAnimateFrame콜백에서 await promise
