...
[^1]: [Rolldown 공식 벤치마크 — rolldown.rs](https://rolldown.rs/benchmarks)
...
[^5]: [WebAssembly threads — web.dev](https://web.dev/webassembly-threads/)
[^6]: [Rust 메모리 안전성 — opensource.com](https://opensource.com/article/21/2/rust-memory-management)
[^7]: [Rust와 WASM 바이너리 크기 — rustwasm.github.io](https://rustwasm.github.io/docs/book/reference/code-size.html)
[^8]: [wasm-bindgen 공식 문서 — rustwasm.github.io](https://rustwasm.github.io/wasm-bindgen/)
[^9]: [State of WebAssembly 2025-2026 — platform.uno](https://platform.uno/blog/state-of-webassembly-2025-and-2026/)
