...
const Nav = () => {
  return (
    <div className="sticky w-full top-2 px-4 pt-2 pb-10 z-10">
      <NavigationMenu className="max-w-none w-full h-16 align-middle justify-between shadow-lg shadow-secondary rounded-xl p-2 bg-background border-border border-2">
