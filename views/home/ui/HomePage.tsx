  ...
  return (
    <>
      <section className={classes.hero}>
        <h1 className={classes.brand}>zakklee</h1>
        <div className={classes.heroRule} />
      ...
      <section className={classes.postsSection}>
        <div className={classes.sectionHeader}>
          <span className={classes.sectionLabel}>Latest Posts</span>
          <div className={classes.sectionAccent} />
        </div>
        {posts
          ?.slice(0, 3)
